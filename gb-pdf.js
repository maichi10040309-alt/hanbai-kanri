...
(function(){
  ...
  async function renderPage(d,c,co,lines,pageIndex,pageCount,templateImage){
    ...
    font(ctx,11);left(ctx,name,20,25,72);left(ctx,suffix,94,29,10);ctx.beginPath();ctx.moveTo(px(20),px(33));ctx.lineTo(px(104),px(33));ctx.lineWidth=Math.max(1,px(0.2));ctx.strokeStyle='#000';ctx.stroke();
