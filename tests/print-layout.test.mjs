...
test('GB1116 print scale can compensate for browser or printer fitting', () => {
  ...
  assert.match(source, /gb-issuer\{[^}]*font-size:8\.5pt;line-height:1\.3;color:#000/);
  assert.match(source, /gb-bank\{[^}]*font-size:8\.5pt;line-height:1\.3/);
  assert.match(source, /gb-customer\{[^}]*font-size:11pt/);
  assert.match(source, /gb-summary\{[^}]*font-size:9pt/);
  assert.match(source, /gb-summary span:last-child\{font-size:11pt;font-weight:700;color:#000\}/);
