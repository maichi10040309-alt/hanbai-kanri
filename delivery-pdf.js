...
(function(){
  ...
  let ink='#d00000';
  function font(ctx,pt,weight=400,color=ink){ctx.font=`${weight} ${pt*DPI/72}px "MS Mincho","ＭＳ 明朝","Yu Mincho",serif`;ctx.fillStyle=color;ctx.textBaseline='top'}
  ...
  function blankForm(ctx,baseY){
    ...
    box(18.5,72,186.5,63);for(const y of [76,84,92,100,108,116,124])line(18.5,y,205,y);
